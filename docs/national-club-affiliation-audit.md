...
| B | 대학 언론, 공식 동아리 채널, 과거 대학 공식 문서 등으로 강하게 확인 |
| 사용자 확인 | 운영자가 직접 확인한 소속 또는 통합 관계 |
| C | 대회 원자료의 팀명 외에는 공개 근거가 부족해 추가 확인 필요 |

공식 자료가 존재하지 않는 경우 검색 결과만으로 학과나 캠퍼스를 추정하지 않았다. 또한 대회에 출전한 팀 단위와 실제 동아리 조직 단위가 다를 수 있으므로, 연합 동아리와 같은 이름의 캠퍼스별 동아리는 별도로 표시했다.

## 전체 조사 결과

| # | 현재 사이트 표기 | 조사 결과와 권장 표기 | 소속 유형 | 판정 | 근거·주의사항 |
| ---: | --- | --- | --- | --- | --- |
...
| 6 | 동국대학교 DUTC | **동국대학교 서울캠퍼스 DUTC** *(잠정)* | 서울캠퍼스 중앙동아리 추정 | B | 서울캠퍼스와 WISE캠퍼스 모두 DUTC가 존재한다. 현재 랭킹의 경인지구 출전 기록은 서울캠퍼스일 가능성이 높지만 원자료 확인이 필요하다. [서울캠퍼스 가이드](https://www.dongguk.edu/resources/files/ot_2025.pdf), [WISE DUTC](https://wise.dongguk.ac.kr/article/wisestudent/detail/512796) |
...
| 10 | 강릉국립대학교 KTCJTC | **소속 미확정: KTCJTC** | 미확정 | C | 원자료에는 `KtcJtc`만 있고 대학명이 없다. `강릉국립대학교`라는 현재 연결을 뒷받침하는 공개 자료도 찾지 못했다. 이 항목은 운영자 확인 전까지 대학명을 확정하면 안 된다. |
...
| 15 | 한양대학교 HYTC | **한양대학교 서울캠퍼스·한양여자대학교 연합 HYTC** | 대학 간 연합동아리 | B | 공식 대학 위키가 한양대와 한양여대 연합 동아리로 설명한다. 대회에서는 학교별 팀으로 따로 출전하므로 랭킹 엔티티 통합 여부는 별도 정책이 필요하다. [HYTC 소개](https://hyu.wiki/HYTC) |
| 16 | 한양여자대학교 HYTC | **한양대학교 서울캠퍼스·한양여자대학교 연합 HYTC** | 대학 간 연합동아리 | B | 15번과 같은 조직이다. 대회 결과가 학교별로 나뉘어 기록된 경우만 별도 점수 엔티티로 유지할 수 있다. [HYTC 소개](https://hyu.wiki/HYTC) |
...
| 18 | 인하대학교 라품 | **인하대학교 라품** | 대학 테니스 동아리 | 사용자 확인 | 운영자가 비룡·라품·라쿤이 같은 동아리라고 확인했다. 공개 대학 자료에서는 중앙·학과 소속 여부를 확인하지 못했다. [공개 커뮤니티 소개](https://www.wepublic.com/c/Inha) |
...
| 25 | 고려대학교 KUTC | **고려대학교 서울캠퍼스 KUTC** | 일반 학생 테니스 동아리 | B | 공개 모집문에서 체육교육과·의과대학과 구분되는 일반 고려대생 동아리로 확인된다. 중앙동아리 등록 여부는 추가 확인이 필요하다. [KUTC 모집 기록](https://www.koreapas.com/m/view.php?id=freead&no=238098) |
| 26 | 고려대학교 PETC | **고려대학교 체육교육과 PETC** | 사범대학 체육교육과 동아리 | 사용자 확인 | 운영자가 학과 소속임을 확인했다. [고려대 체육교육과](https://phyedu.korea.ac.kr/) |
| 27 | 경희대학교 국제캠퍼스 임팩트 | **경희대학교 국제캠퍼스 임팩트** *(잠정)* | 국제캠퍼스 동아리 추정 | C | 대회 원자료에 `경희대 국제 임팩트`가 있어 캠퍼스는 강하게 추정되지만 공식 동아리 목록에서 조직을 확인하지 못했다. |
| 28 | 경희대학교 국제캠퍼스 KUTA | **소속 재확인 필요: 국제캠퍼스 KUTA** | 미확정 | C | KUTA는 공식적으로 서울캠퍼스 중앙동아리로 확인된다. 양구 원자료의 `Kuta`만으로 국제캠퍼스 조직을 별도로 만들 근거가 부족하다. |
...
| 52 | 금오공과대학교 KOTC | **국립금오공과대학교 KOTC(금오테니스?)** | 대학 테니스 동아리 추정 | B | 대회 원자료에는 KOTC로 나오지만 최신 대학 공식 자료는 `금오테니스`로 표기한다. 같은 조직의 약칭인지 확인이 필요하다. [금오공대 공식 안내](https://www.kumoh.ac.kr/cms/fileOpen.do?path=%2F_res%2Fipsi%2Fetc%2F2025susi_mozip.pdf) |
| 53 | 광운대학교 KWTC | **광운대학교 KWTC** | 중앙동아리 | A | 대학 공식 중앙동아리 목록에서 확인된다. [광운대 동아리](https://www.kw.ac.kr/ko/life/activity03.jsp) |
| 54 | 경희대학교 임팩트 | **경희대학교 국제캠퍼스 임팩트와 통합 검토** | 중복 표기 가능성 | C | 캠퍼스가 생략된 춘천 원자료다. 27번과 같은 동아리일 가능성이 높지만 자동 통합 전 확인이 필요하다. |
...
| 58 | 남서울대학교 위닝샷 | **남서울대학교 위닝샷** *(소속 유형 미확정)* | 미확정 | C | 대회 원자료에서는 확인되지만 대학 공식 중앙·학과동아리 자료에서 공개 근거를 찾지 못했다. |
...
- 국제캠퍼스 임팩트: 대회 표기로는 확인되나 공식 조직 자료 필요
- 국제캠퍼스 KUTA: 별도 조직인지 재확인 필요
- 셔틀: 캠퍼스·학과 미확정
- 캠퍼스가 빠진 KUTA·러비스·임팩트: 각각 공식 캠퍼스 조직과 중복일 가능성이 높음

현재 8개로 나뉜 경희대 엔티티는 그대로 두기보다 원자료를 한 건씩 확인한 후 정리해야 한다.
...
1. `KTCJTC`의 정확한 대학과 캠퍼스
2. 동국대 DUTC 결과가 서울캠퍼스인지 WISE캠퍼스인지
3. 한양대·한양여대 HYTC를 랭킹에서 한 조직으로 합칠지, 출전 학교별로 유지할지
4. 경희대 국제캠퍼스 임팩트의 공식 조직 유형
5. 경희대 국제캠퍼스 KUTA가 실제 별도 조직인지
6. 경희대 셔틀의 캠퍼스·학과
7. 명지대 러시앤·테사랑·티샷과 현재 MJTA의 관계
8. 성균관대 공자·맹자·순자·SIT가 모두 STC 팀명인지, 캠퍼스별 조직인지
9. 금오공대 KOTC와 현재 공식 명칭 `금오테니스`가 같은 조직인지
10. 남서울대 위닝샷의 중앙·학과동아리 여부
11. 인하대 라품의 중앙·학과동아리 여부

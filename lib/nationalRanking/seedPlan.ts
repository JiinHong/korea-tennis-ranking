...
import { NATIONAL_FORMULA_V10 } from "./formula";
import type {
...
export type NationalRankingSeedPlan = {
  ...
  formula: {
    version: typeof NATIONAL_FORMULA_V10.version;
    displayName: string;
    config: typeof NATIONAL_FORMULA_V10;
    effectiveOn: string;
...
export function buildNationalRankingSeedPlan(
  ...
  return {
    ...
    formula: {
      version: NATIONAL_FORMULA_V10.version,
      displayName: "National Club Ranking v10",
      config: NATIONAL_FORMULA_V10,

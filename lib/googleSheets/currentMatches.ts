// Google Sheets 인증과 API 객체 생성은 같은 폴더의 client 모듈이 담당한다.
...
import {getSheetsClient, getSpreadsheetId} from "@/lib/googleSheets/client";

import {parseRank} from "@/lib/campusRanking/rank";
